...
describe('Stop Pos Session', () => {
    ...
    it('should return status code 400 when request body is null', async () => {
        try {
            await request.post(`${helpers.API_URL}/api/v1/stop-pos-session`, {
                json: true,
                headers: {
            ...
            const response = {
                code: 400,
                description: 'You\'ve requested to stop pos session but the request body seems to be empty. Kindly specify the request body in application/json format',
